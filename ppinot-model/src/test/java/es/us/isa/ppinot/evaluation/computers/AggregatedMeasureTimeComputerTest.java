...
public class AggregatedMeasureTimeComputerTest extends MeasureComputerHelper {
    ...
    public void testComputeAggregatedTimeAbsolute1DayScope() {
        ...
        DateTime now = new DateTime(2017, 11, 28, 17, 45);

        computer.update(helper.newInstance("i1", EventType.ready, now.plusDays(-6)));
        computer.update(helper.newInstance("i3", EventType.ready, now.plusDays(-6)));
        computer.update(helper.newInstance("i4", EventType.ready, now.plusDays(-6)));
        computer.update(helper.newInstance("i5", EventType.ready, now.plusDays(-6)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i1", now.plusDays(-5)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i1", now.plusDays(-4)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i1", now.plusDays(-5)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i1", now.plusDays(-4)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i3", now.plusDays(-5)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i3", now.plusDays(-4)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i3", now.plusDays(-5)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i3", now.plusDays(-4)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i1", now.plusDays(-4)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i1", now.plusDays(-3)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i4", now.plusDays(-4)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i4", now.plusDays(-3)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i5", now.plusDays(-4)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i5", now.plusDays(-2)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i4", now.plusDays(-2)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i4", now.plusDays(-1)));
        computer.update(helper.newEntry("Analyse RFC", EventType.ready, "i1", now.plusDays(-2)));
        computer.update(helper.newEntry("Analyse RFC", EventType.complete, "i1", now.plusDays(-1)));
        computer.update(helper.newInstance("i1", EventType.complete, now.minusDays(1)));
        computer.update(helper.newInstance("i3", EventType.complete, now.minusDays(4).plusMillis(10)));
        computer.update(helper.newInstance("i4", EventType.complete, now.minusDays(1).plusMillis(20)));
        computer.update(helper.newInstance("i5", EventType.complete, now.minusDays(2).plusMillis(30)));
