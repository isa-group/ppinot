 ...
 * @param <D> the actual type of diagram to be used (must inherit from {@link org.oryxeditor.server.diagram.generic.GenericDiagram}); {@link GenericShape#getDiagram()} will return this type
 */
public abstract class GenericDiagramBuilder 
	...
	public D parse(JSONObject json) throws JSONException {
		...
		for (Entry<String, JSONObject> entry : flatJSON.entrySet()) {
