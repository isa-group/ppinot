...
/**
 * Implementation for the {@link org.oryxeditor.server.diagram.generic.GenericShape} interface
 * 
 * @author Philipp Maschke, Robert Gurol
 *
 * @param <S> the actual type of shape to be used (must inherit from {@link org.oryxeditor.server.diagram.generic.GenericShape}); calls to {@link #getChildShapesReadOnly()}, ... will return this type
