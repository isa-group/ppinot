...
public class PPINOT2OWLConverter extends ToOWLConverter implements PPINOT2OWLConverterInterface {
	...
	// URI de la ontolog�a base BPMN 2.0
	private String bpmnOntologyURI;
	// URI de la ontolog�a BPMN relacionada con el proceso
	private String bpmnGeneratedOntologyURI;
	// Objeto que maneja el modelo con la informaci�n del BPMN relacionado con el proceso
	private Bpmn20ModelHandlerInterface bpmn20ModelHandler;
	
	// objeto mediante el cual se generan los axiomas que se adicionan a la ontolog�a creada
	...
	/**
	 * Ejecuta las operaciones propias de cada subclase para generar la ontolog�a a partir de un ModelHandleInterface
	 * 
	 * @param modelHandler Objeto ModelHandleInterface a partir del cual se genera la ontolog�a
	 * @throws OWLOntologyCreationException
	 */
    @Override
	protected void generateOntology(ModelHandleInterface modelHandler) throws OWLOntologyCreationException {
    	
    	// adiciona las declaraciones que indican las ontolog�as importadas en la ontolog�a generada
    	String[] uris = { bpmnOntologyURI, Vocabulary.URI, bpmnGeneratedOntologyURI };
    	this.addOntologyImports(uris);
    	
    	// crea el objeto mediante el cual se generan los axiomas que se adicionan a la ontolog�a creada
		...
		try {
			...
			// adiciona a la ontolog�a cada uno de los tipos de elementos PPINOT
	...
	/**
	 * Da valor a propiedades de la clase que tienen informaci�n sobre el BPMN relacionado con el mismo proceso
	 * 
	 * @param bpmnGeneratedOntologyURI URI de la ontolog�a BPMN relacionada con el proceso
	 * @param bpmn20ModelHandler Objeto que maneja el modelo con la informaci�n del BPMN relacionado con el proceso
	 */
	...
	/**
	 * Adiciona a la ontolog�a las medidas CountInstanceMeasure
	 * 
	...
	/**
	 * Adiciona a la ontolog�a las medidas TimeInstanceMeasure
	 * 
	 * @param modelMap Map de las medidas
	 * @throws Exception
	 */
	...
	/**
	 * Adiciona a la ontolog�a las medidas StateConditionInstanceMeasure
	 * 
	 * @param modelMap Map de las medidas
	 * @throws Exception
	 */
	...
	/**
	 * Adiciona a la ontolog�a las medidas DataPropertyConditionInstanceMeasure
	 * 
	 * @param modelMap Map de las medidas
	 * @throws Exception
	 */
	...
	/**
	 * Adiciona a la ontolog�a las medidas DataInstanceMeasure
	 * 
	 * @param modelMap Map de las medidas
	 * @throws Exception
	 */
	...
	/**
	 * Adiciona a la ontolog�a las medidas AggregatedMeasure
	 * 
	 * @param modelMap Map de las medidas
	 * @throws Exception
	 */
	...
	/**
	 * Adiciona a la ontolog�a las medidas DerivedMeasure
	 * 
	 * @param modelMap Map de las medidas
	 * @throws Exception
	 */
	...
	/**
	 * Adiciona a la ontolog�a los Ppi
	 * 
	 * @param modelMap Map de las medidas
	 * @throws Exception
	 */
